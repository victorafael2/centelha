...
<!-- <html lang="en-US" dir="ltr"> -->
  ...
  <head>
    ...
    <!--    Favicons-->
    <!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180" href="https://matech-solution.com.br/img/clients/logo9.png">
    <link rel="icon" type="image/png" sizes="32x32" href="https://matech-solution.com.br/img/clients/logo9.png">
    <link rel="icon" type="image/png" sizes="16x16" href="https://matech-solution.com.br/img/clients/logo9.png">
    <link rel="shortcut icon" type="image/x-icon" href="https://matech-solution.com.br/img/clients/logo9.png">
          ...
          <div class="navbar-logo">
            ...
            <a class="navbar-brand me-1 me-sm-3" href="index.php">
              <div class="d-flex align-items-center">
                <div class="d-flex align-items-center"><img src="https://matech-solution.com.br/img/clients/logo9.png" alt="centelha" width="80" />
          ...
          <div class="pb-5">
            <div class="row g-4">
              <div class="col-12 col-xxl-6">
                <div class="mb-3">
                  <h2 class="mb-2">Buscar Grupos de Pesquisas</h2>
              ...
              <div id="authenticatedContent" style="display: none;" class="mt-5">
