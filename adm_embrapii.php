...
<body>
                ...
                <div class="navbar-logo">
                    ...
                    <a class="navbar-brand me-1 me-sm-3" href="index.php">
                        <div class="d-flex align-items-center">
                            <div class="d-flex align-items-center"><img src="assets/img/brand2/centelha.png"
                                    alt="centelha" width="80" />
                            ...
                            <div class="card position-relative border-0">
                                ...
                                <div class="overflow-auto scrollbar" style="height: 10rem;">
                                    <ul class="nav d-flex flex-column mb-2 pb-1">
                                        <li class="nav-item"><a class="nav-link px-3" href="buscas.php"><i
                                                    class="fa-solid fa-list"></i> <span> Buscas Feitas</span></a></li>
                ...
                <div class="pb-5">
                    <div class="row g-4">
                        <div class="col-12 col-xxl-12">
                            <div class="mb-3">
                                <h2 class="mb-2">Buscar Grupos de Pesquisas e Editais</h2>
                                ...
                                <ul class="nav nav-tabs nav-underline">
                                    <li class="nav-item mb-1">
                                        <a class="nav-link active" id="tab1" data-bs-toggle="tab"
                                            href="#geral">Busca Embrapii</a>
                                    </li>
                                    <!-- <li class="nav-item mb-1">
                                        <a class="nav-link " id="tab1" data-bs-toggle="tab"
                                            href="#pesquisador">Pesquisadores</a>
                                    </li>
                                    <li class="nav-item mb-1">
                    ...
                    <div class="row g-0 justify-content-between align-items-center h-100">
                        <div class="col-12 col-sm-auto text-center">
                            <div class="col-xl-auto text-center"><a href="#"><img
                                        src="https://deployvr.online/define/assets/img/icons/logo-white.png" height="48"
                                        alt="" /></a></div>
    ...
    <script src="https://cdn.jsdelivr.net/npm/amazon-cognito-identity-js@4.5.3/dist/amazon-cognito-identity.min.js">
    </script>
